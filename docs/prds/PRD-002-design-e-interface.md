...
- **Fundos (Backgrounds):** Fundos escuros (Dark Mode prioritário) com manchas de cores vibrantes e gradientes dinâmicos (ex: tons de neon, roxo, azul) que brilham por trás dos elementos de vidro.

## 🖼️ Referências Visuais
O design deve consumir e se inspirar nos assets providenciados:
- **Logos (`docs/referencias/logos-perfil`):** Utilização correta das versões horizontal e vertical. A imagem de perfil pode ser usada na seção "Sobre o Especialista".
...
- **Paleta de Cores:** Fundo Dark, elementos de superfície translúcidos (Glass), e accent colors vibrantes (a definir, sugestão: Azul/Roxo neon ou cores da marca original se houver no logo) para os botões de conversão e elementos de destaque.
